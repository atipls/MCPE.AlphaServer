...
namespace fNbt {
    ...
    public class NbtReader {
        ...
        /// <exception cref="Exception"> If an error occurred while parsing data in NBT format. </exception>
        /// <exception cref="Exception"> If NbtReader cannot recover from a previous parsing error. </exception>
            ...
            switch (state) {
                case NbtParseState.AtStreamBeginning:
                    ...
                    if (reader.ReadTagType() != NbtTagType.Compound) {
                        state = NbtParseState.Error;
                        throw new Exception("Given NBT stream does not start with a TAG_Compound");
                    }
                    Depth = 1;
                ...
                case NbtParseState.InList:
                    ...
                    if (ListIndex >= ParentTagLength) {
                        ...
                        if (ParentTagType == NbtTagType.List) {
                            ...
                            state = NbtParseState.Error;
                            throw new Exception(InvalidParentTagError);
                        }
                    } else {
                        if (canSeekStream) {
                            TagStartOffset = (int)(reader.BaseStream.Position - streamStartOffset);
                ...
                default:
                    ...
                    throw new Exception(ErroneousStateError);
            }
        }
        ...
        void ReadTagHeader(bool readName) {
            ...
            switch (TagType) {
                ...
                case NbtTagType.List:
                    ...
                    TagLength = reader.ReadInt32();
                    if (TagLength < 0) {
                        throw new Exception("Negative tag length given: " + TagLength);
                    }
                ...
                default:
                    state = NbtParseState.Error;
                    throw new Exception("Trying to read tag of unknown type.");
            }
        }
