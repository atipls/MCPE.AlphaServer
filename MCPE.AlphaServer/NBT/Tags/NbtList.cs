...
namespace fNbt {
    ...
    public sealed class NbtList : NbtTag, IList<NbtTag>, IList {
        ...
        internal override bool ReadTag(NbtBinaryReader readStream) {
            ...
            if (length < 0) {
                throw new Exception("Negative list size given.");
            }
            ...
            for (int i = 0; i < length; i++) {
                ...
                switch (ListType) {
                    ...
                    default:
                        ...
                        throw new Exception("Unsupported tag type found in a list: " + ListType);
                }
                newTag.Parent = this;
        ...
        internal override void WriteData(NbtBinaryWriter writeStream) {
            if (ListType == NbtTagType.Unknown) {
                throw new Exception("NbtList had no elements and an Unknown ListType");
            }
